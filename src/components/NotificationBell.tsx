...
export default function NotificationBell() {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div
          className="absolute z-50 mt-2 left-1/2 -translate-x-1/2 w-[95vw] max-w-[420px] sm:w-96 sm:max-w-md sm:right-0 sm:left-auto sm:translate-x-0 bg-white rounded-lg shadow-lg border border-gray-200 dark:bg-slate-800 dark:border-slate-600 max-h-96 overflow-hidden"
        >
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-slate-600">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 truncate">Notifications</h3>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-1 gap-1">
                          <div className="flex items-center space-x-2 min-w-0">
                            <span className="text-sm font-medium text-gray-900 dark:text-slate-100 truncate max-w-[60vw]">{log.action}</span>
                            {/* Created by user */}
                            <span className="text-xs text-gray-500 dark:text-slate-300 whitespace-nowrap ml-2">Created by {log.user}</span>
                          </div>
                        ...
                        <div className="text-sm text-gray-600 mb-1 dark:text-slate-300 truncate max-w-[80vw]">
                          {getLogSummary(log)}
                        </div>
                      </div>
                    </div>
